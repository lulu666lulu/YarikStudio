...
namespace AssetStudio.CLI
{
    ...
    internal sealed class AssetsManagerOptions
    {
        ...
        public string SpecifyUnityVersion { get; set; }
    }
    ...
    internal static class Studio
    {
        ...
        public static Implementation Create(AssetsManagerOptions options)
        {
            var impl = new Implementation();
            impl.assetsManager.ResolveDependencies = options.ResolveDependencies;
            impl.assetsManager.Silent = options.Silent;
            impl.assetsManager.Game = options.Game;
            impl.assetsManager.SpecifyUnityVersion = options.SpecifyUnityVersion;
            return impl;
        }
        ...
        {
            public AssetsManager assetsManager = new AssetsManager() { ResolveDependencies = false };
            ...
            private int ExtractStreamFile(string extractPath, List<StreamFile> fileList)
            {
                int extractedCount = 0;
            ...
            public void BuildAssetData(ClassIDType[] typeFilters, Regex[] nameFilters, Regex[] containerFilters,
                ref int i)
            {
            ...
            public void ProcessAssetData(Object asset, Dictionary<Object, AssetItem> objectAssetItemDic,
                List<(PPtr<Object>, string)> mihoyoBinDataNames, List<(PPtr<Object>, string)> containers, ref int i)
            {
            ...
            public void ExportAssets(string savePath, List<AssetItem> toExportAssets,
                AssetGroupOption assetGroupOption, ExportType exportType)
            {
                ...
                foreach (var asset in toExportAssets)
                {
                    ...
                    switch (assetGroupOption)
                    {
                        ...
                        case AssetGroupOption.BySource: //source file
                            ...
                            {
                                exportPath = Path.Combine(savePath,
            ...
            public void ExportAssetsMap(string savePath, List<AssetEntry> toExportAssets, string exportListName,
